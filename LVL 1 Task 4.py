# Найти среднее значение элементов массива размером 5. Преобразовать исходный массив, вычитая из каждого элемента полученное значение.
...
if avg == int(avg):
    ...
    avg = round(avg, 1)
    print('Среднее значение элементов массива равно', avg)
print()
